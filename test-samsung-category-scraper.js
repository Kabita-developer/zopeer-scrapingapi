...
async function testSamsungCategoryScraper() {
  const scraper = new SamsungCategoryScraper();
  
  try {
    console.log('🚀 Starting Samsung Category Scraper Test...\n');
    
    // Test URL from the user's request (Samsung offers page)
    ...
    console.log(`📁 Data saved to: scraped_data/samsung-category-*.json`);
...
if (require.main === module) {
  testSamsungCategoryScraper();
}

module.exports = testSamsungCategoryScraper;
